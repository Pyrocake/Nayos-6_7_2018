...
public class TileEntityNativusHarmony extends TileEntity implements IInventory, ITickable
{
	...
	{
		return this.hasCustomName() ? this.customName : "container.NativusForge";
	}
	...
	public void update() 
	{
		...
		if(!this.world.isRemote) 
		{
			...
			{
				flag1 = true;
				NativusCraftBaseBlock.setState(this.isBurning(), this.world, this.pos);
			}
		} 
	...
	private boolean canSmelt() 
	{
		...
		{
			ItemStack result = HarmonyFurnaceRecipes.getInstance().getHarmonyResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));	
	...
	public void smeltItem() 
	{
		if(this.canSmelt()) 
		{
			...
			ItemStack result = HarmonyFurnaceRecipes.getInstance().getHarmonyResult(input1, input2);
			ItemStack output = (ItemStack)this.inventory.get(3);
